...
describe("MusicNFTMarketplace", function() {
    ...
    describe("reselling tokens", function () {
        ...
        it("Should track resale item, incr ether bal by royalty, transfer NFT to marketplace and emit MarketItemlisted event", async function () {
        });

        it("Should fall if price is set to zero and royalty fee is not paid", async function () {
